  ...
  async function manufactureComponents() {
    ...
    if (!isAllowed) {
      ...
      try {
        ...
        await coreInstance.manufactureComponents(upc, notes, price, { from: currentAccount });
        ...
        statusOutput.innerText = "Something went wrong! or Excpected event not thrown";
      }
  ...
  async function buySmartphoneFromCompany() {
    ...
    if (!isAllowed) {
      ...
      try {
        ...
        statusOutput.innerText = "Something went wrong! Make sure smartphone has been assembled";
      }
